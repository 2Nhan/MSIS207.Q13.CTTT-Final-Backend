...
public class SecurityConfiguration {
    private final String[] PUBLIC_ENDPOINTS = {"/api/v1/authentication/registration",
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.oauth2ResourceServer(resourceServer -> resourceServer
                .jwt(jwtConfigurer -> jwtConfigurer.decoder(jwtDecoder).jwtAuthenticationConverter(this.jwtAuthenticationConverter()))
    ...
    public CorsFilter corsFilter() {
        ...
        config.addAllowedOrigin("http://13.251.45.52:8088");
        config.addAllowedOrigin("http://13.251.45.52");
